...
def main():
    ...
    word_output_path = "/Users/AbdullahMS/Desktop/Work/TCS/Int/db_Intern_project/Data/output_file/output.docx"  # Desired output Word document path
    ...
    # Save figures to Word document, excluding logos
